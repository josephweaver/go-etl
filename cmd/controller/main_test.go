...
func writeControllerStartupFiles(t *testing.T, dir string) (string, string, string) {
  ...
  "variables": [
    ...
    {"name": {"namespace": "controller_config", "key": "controller_log_read_default_tail_lines"}, "type": "int", "expression": 100},
    {"name": {"namespace": "controller_config", "key": "controller_log_read_max_tail_lines"}, "type": "int", "expression": 1000},
...
func TestResolveControllerOperationalPolicy(t *testing.T) {
	...
	resolver := variable.NewResolver(variable.NewSet(testStartupScope(t,
		...
		testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_default_tail_lines", variable.TypeInt, 100),
		testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_max_tail_lines", variable.TypeInt, 1000),
	)), variable.ResolverConfig{})
	...
	if policy.LogReadDefaultTailLines != 100 {
		t.Fatalf("log read default tail lines = %d, want 100", policy.LogReadDefaultTailLines)
	}
	if policy.LogReadMaxTailLines != 1000 {
		t.Fatalf("log read max tail lines = %d, want 1000", policy.LogReadMaxTailLines)
	}
}
...
func TestResolveControllerOperationalPolicyRejectsInvalidValues(t *testing.T) {
	tests := []struct {
		...
		{
			name: "default tail lines missing",
			variables: []variable.Variable{
				testStartupVariable(variable.NamespaceControllerConfig, "resolver_max_depth", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_interval_schedule_milliseconds", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_missed_interval_limit", variable.TypeInt, 1),
			...
			want: "controller_log_read_default_tail_lines",
		},
		{
			name: "max tail lines missing",
			variables: []variable.Variable{
				testStartupVariable(variable.NamespaceControllerConfig, "resolver_max_depth", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_interval_schedule_milliseconds", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_missed_interval_limit", variable.TypeInt, 1),
			...
			want: "controller_log_read_max_tail_lines",
		},
		{
			...
			variables: []variable.Variable{
				...
				testStartupVariable(variable.NamespaceControllerConfig, "controller_filesystem_logging_enabled", variable.TypeBool, true),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_root_path", variable.TypePath, "./logs"),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_level", variable.TypeString, "invalid-level"),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_default_tail_lines", variable.TypeInt, 100),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_max_tail_lines", variable.TypeInt, 1000),
			},
			want: "invalid level: invalid-level",
		},
		{
			name: "default tail lines not positive",
			variables: []variable.Variable{
				testStartupVariable(variable.NamespaceControllerConfig, "resolver_max_depth", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_interval_schedule_milliseconds", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_missed_interval_limit", variable.TypeInt, 1),
				...
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_root_path", variable.TypePath, "./logs"),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_level", variable.TypeString, "debug"),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_default_tail_lines", variable.TypeInt, 0),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_max_tail_lines", variable.TypeInt, 1000),
			},
			want: "controller_log_read_default_tail_lines must be greater than zero",
		},
		{
			name: "max tail lines not positive",
			variables: []variable.Variable{
				testStartupVariable(variable.NamespaceControllerConfig, "resolver_max_depth", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_interval_schedule_milliseconds", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_missed_interval_limit", variable.TypeInt, 1),
				...
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_level", variable.TypeString, "debug"),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_default_tail_lines", variable.TypeInt, 100),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_max_tail_lines", variable.TypeInt, 0),
			},
			want: "controller_log_read_max_tail_lines must be greater than zero",
		},
		{
			name: "max tail lines less than default",
			variables: []variable.Variable{
				testStartupVariable(variable.NamespaceControllerConfig, "resolver_max_depth", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_interval_schedule_milliseconds", variable.TypeInt, 1),
				testStartupVariable(variable.NamespaceControllerConfig, "caretaker_missed_interval_limit", variable.TypeInt, 1),
				...
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_level", variable.TypeString, "debug"),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_default_tail_lines", variable.TypeInt, 100),
				testStartupVariable(variable.NamespaceControllerConfig, "controller_log_read_max_tail_lines", variable.TypeInt, 50),
			},
			want: "controller_log_read_max_tail_lines must be greater than or equal to controller_log_read_default_tail_lines",
		},
	}
