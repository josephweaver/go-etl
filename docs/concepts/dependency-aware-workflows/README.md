...
This bundle is aligned to the current repo convention on `docs/concepts/dependency-aware-workflows`: place it under `docs/concepts/dependency-aware-workflows/`.
