...
Do not make resource constraints a dependency-state membership concern. Dependency membership answers â€œwhich step/stage owns this work item?â€ Resource constraints answer â€œmay this queued work item be claimed now?â€
