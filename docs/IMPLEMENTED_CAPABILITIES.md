...
## Capability State Sources

- Data assets, materialized inputs, artifacts, and publication: [`concepts/data-assets-and-materialized-outputs/STATE.md`](concepts/data-assets-and-materialized-outputs/STATE.md)
- Dependency-aware workflows and staged activation: [`concepts/dependency-aware-workflows/STATE.md`](concepts/dependency-aware-workflows/STATE.md)
- Resource-constrained work admission: [`concepts/resource-constrained-work-admission/STATE.md`](concepts/resource-constrained-work-admission/STATE.md)
...
## Full Pre-Split Record

The complete pre-split state file is preserved at [`history/PROJECT_STATE_2026-07-07_pre-split.md`](history/PROJECT_STATE_2026-07-07_pre-split.md).